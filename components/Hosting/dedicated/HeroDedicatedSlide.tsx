                            ...
                            <div className="container xl:max-w-[1200px] mx-auto">
                                <div className="flex flex-wrap items-center">
                                    <div className="xl:w-7/12 md:w-2/3 w-full px-4 text-white-100">
                                        <h3 className="text-3xl mb-0 uppercase">West Coast</h3>
                                        <h3 className="text-3xl font-bold uppercase mb-2">Here we come!</h3>
                                        <p className="text-xl mb-5">OpticEngine is expanding in the US and is now offering cloud servers with AMD processors in Ashburn, Virginia, and Hillsboro, Oregon, USA!</p>
                                        <div>
                                            <button className="inline-block px-2 py-1 rounded-md scale-[1] hover:scale-[1.1] transition-all bg-blue-300 text-white-100 mr-3 mb-3">
                                                OpticEngine Cloud
                                            </button>
                                            <button className="inline-block px-2 py-1 rounded-md scale-[1] hover:scale-[1.1] transition-all bg-dark-200 text-white-100">
                                                Learn More
                                            </button>
                                        </div>
                                    </div>

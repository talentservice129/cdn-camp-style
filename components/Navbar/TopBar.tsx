...
function TopBar({toggleMode}: any) {
      ...
      <div className="hidden w-full h-[25px] mt-4 items-center lg:flex justify-end">
        <ul className="flex justify-end">
          ...
          <li className="hidden md:flex py-0 items-center justify-center px-[10px]">
            ...
            <p className="dark:text-white-100 px-3 border-r border-solid border-1 dark:marker:border-white-400 text-[12px]">+1 323 892 0977</p>
          </li>
